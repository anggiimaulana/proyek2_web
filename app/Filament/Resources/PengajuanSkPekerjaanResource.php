...
use App\Filament\Resources\PengajuanSkPekerjaanResource\Pages;
use App\Filament\Resources\PengajuanSkPekerjaanResource\RelationManagers;
...
class PengajuanSkPekerjaanResource extends Resource
{
                ...
                Select::make('nik_id')
                    ...
                    ->afterStateUpdated(function (callable $set, $state) {
                        ...
                        if ($nikData) {
                            ...
                            $set('pekerjaan_terdahulu', $nikData->pekerjaan);
    ...
    {
        return [
            'index' => Pages\ListPengajuanSkPekerjaans::route('/'),
            'create' => Pages\CreatePengajuanSkPekerjaan::route('/create'),
            'edit' => Pages\EditPengajuanSkPekerjaan::route('/{record}/edit'),
        ];
    }
}
