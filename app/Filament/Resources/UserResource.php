...
class UserResource extends Resource
{
    ...
    protected static ?string $label = 'Data Akun Admin';
    protected static ?string $pluralLabel = 'Data Akun Admin';

    protected static ?string $navigationLabel = 'Data Akun Admin';
